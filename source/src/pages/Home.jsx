...
const Home = () => {
  ...
  const handleSearch = (e) => {
    ...
    setQuery(searchTerm); // update query only when button is clicked
  };
        ...
        <div className='flex items-center justify-center border  border-slate-900 rounded-full w-[250px] lg:w-[700px] md:w-[400px] sm:w-[250px] my-6 md:my-10 lg:my-12 mx-auto relative'> 
          <form onSubmit={handleSearch} className='flex justify-center w-full'>
            ...
            <input
             ...
             className='flex-1 px-8 p-2 rounded-full border-none'
             />
           
             <button type='submit' className='bg-blue-400 text-white font-semibold mx-auto absolute right-0  top-0  rounded-r-full p-2 '>search</button>
          </form>
        </div>
